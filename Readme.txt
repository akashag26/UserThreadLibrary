1. Extract “aagrawa6_P1.zip”
unzip aagrawa6_P1.zip

2. Type the following command to create mythread.a using makefile
make 

3. To clean the existing .o and mythread.a files type:
make clean
...
(mythreadextra.h) contains everything in the original header plus the definition of MyThreadInitExtra().
